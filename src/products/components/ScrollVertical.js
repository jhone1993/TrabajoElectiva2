...
const ScrollVertical= () => {
    ...
    return(
        ...
        <Section>
            ...
            <Container>
            <center><h1><strong>Basic Scroll Verticall</strong></h1>
